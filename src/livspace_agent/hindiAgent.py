...
from livspace_agent.hindiPrompt import INSTRUCTIONS
...
class LivspaceInboundHindiAgent(Agent):
    ...
    async def on_enter(self) -> None:
        ...
        # await self.session.say("मैंने आपकी पसंद नोट कर ली है। अब मैं हिंदी में उत्तर दूँगी।", allow_interruptions=False)
